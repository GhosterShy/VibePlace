...
//                'Authorization': 'Bearer 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',
//            },
//            body: JSON.stringify({
...
//        // Show typing indicator in header (replace "• Online")
//        onlineStatus.style.display = 'none';
//        typingIndicatorHeader.style.display = 'inline-block';

//        // Get AI response
//        const aiResponse = await getAIResponse(message);

//        // Hide typing indicator in header and show "• Online" again
//        typingIndicatorHeader.style.display = 'none';
//        onlineStatus.style.display = 'inline-block';

//        // Create a container for the typing indicator in chat messages
//        const typingContainer = document.createElement('div');
//        typingContainer.classList.add('message-container');
//        const typingElement = document.createElement('div');
//        typingElement.classList.add('typing-indicator');
//        typingElement.innerHTML = 'Печатает<span>.</span><span>.</span><span>.</span>';
...
///*test2 */
//// Загрузка сообщений из localStorage при старте
...
//// Обнови функцию sendMessage для сохранения
//async function sendMessage() {
//    if (!isAuthorized) {
//        authContainer.classList.add('active');
//        return;
...
//            // Save AI response
//            savedMessages.push({ text: aiResponse, type: 'received' });
//            localStorage.setItem('chatMessages', JSON.stringify(savedMessages));
//        }
